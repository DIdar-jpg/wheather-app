  ...
  return (
        <div className="flex justify-center relative text-gray-500">
            <div className="relative md:w-80">
                <input type="text" className="w-full p-2 pl-8 rounded border border-gray-200 bg-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" placeholder="Введите название  города" defaultValue="" />
